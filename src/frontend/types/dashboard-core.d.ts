...
interface AppTab {
  ...
  componentManifest?: {
    ...
    children?: Array<{ id: string; displayName?: string; description?: string; enabled?: boolean; status?: 'active' | 'disabled' | 'untrusted' | 'unhealthy'; health?: string }>;
  };
