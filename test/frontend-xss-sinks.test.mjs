...
const APPROVED_SINKS = new Map([
  ...
  ["src/frontend/chat/chat-token.ts|doCompact|innerHTML|msgsEl", approved(1, "ea24bc001070", REVIEW.renderer)],
  ...
  ["src/frontend/dashboard/dashboard-chat.ts|_applyMsgsDiff|innerHTML|msgsEl", approved(2, "7fa32ee99ca0", REVIEW.renderer)],
  ...
  ["src/frontend/dashboard/dashboard-layout.ts|renderAgentToolCollectionTab|innerHTML|root", approved(1, "f67bf84b3d5a", REVIEW.escaped)],
  ["src/frontend/dashboard/dashboard-layout.ts|renderComponentTab|innerHTML|root", approved(1, "cb27f5396dfe", REVIEW.escaped)],
  ["src/frontend/dashboard/dashboard-layout.ts|renderExtensionSettingsFields|innerHTML|host", approved(1, "6f49cdbd80e1", REVIEW.clear)],
  ["src/frontend/dashboard/dashboard-layout.ts|renderMcpServerTab|innerHTML|root", approved(4, "0dfae7412614", REVIEW.escaped)],
  ...
  ["src/frontend/dashboard/dashboard-sessions.ts|_sessionClose|innerHTML|msgsEl", approved(1, "67618d376912", REVIEW.renderer)],
  ["src/frontend/dashboard/dashboard-sessions.ts|_setupDraftSession|innerHTML|msgsEl", approved(1, "a11a739db5da", REVIEW.static)],
  ["src/frontend/dashboard/dashboard-sessions.ts|branchSession|innerHTML|msgsEl", approved(1, "67618d376912", REVIEW.renderer)],
  ["src/frontend/dashboard/dashboard-sessions.ts|closeSessionTab|innerHTML|msgsEl", approved(1, "67618d376912", REVIEW.renderer)],
  ["src/frontend/dashboard/dashboard-sessions.ts|deleteSession|innerHTML|cs", approved(1, "49ffb5728b2e", REVIEW.primitive)],
  ["src/frontend/dashboard/dashboard-sessions.ts|deleteSession|innerHTML|msgsEl", approved(1, "67618d376912", REVIEW.renderer)],
  ...
  ["src/frontend/dashboard/session-activation.ts|renderMessages|innerHTML|messagesElement", approved(1, "91ee9c68ecdc", REVIEW.renderer)],
  ...
  ["src/frontend/pane/components/index.ts|openMcpInstallDialog|innerHTML|overlay", approved(1, "bffda0cf33a4", REVIEW.static)],
