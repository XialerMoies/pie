...
const APPROVED_SINKS = new Map([
  ...
  ["src/frontend/chat/chat-token.ts|render|innerHTML|container", approved(4, "4edae41047a8", REVIEW.escaped)],
  ["src/frontend/chat/chat-token.ts|renderCurrentSessionUsage|innerHTML|container", approved(2, "4d3fb9834849", REVIEW.escaped)],
  ...
  ["src/frontend/dashboard/dashboard-settings.ts|loadCustomSubagents|innerHTML|list", approved(1, "f1a3f62d3955", REVIEW.static)],
  ["src/frontend/dashboard/dashboard-settings.ts|loadProviderModels|innerHTML|container", approved(3, "94ec61d3da3b", REVIEW.escaped)],
  ["src/frontend/dashboard/dashboard-settings.ts|mount|insertAdjacentHTML|container", approved(1, "6a24ec05a936", REVIEW.renderer)],
  ["src/frontend/dashboard/dashboard-settings.ts|provDrop|innerHTML|list", approved(1, "97a8035a3fe2", REVIEW.renderer)],
  ["src/frontend/dashboard/dashboard-settings.ts|render|innerHTML|editor", approved(2, "fbc2f48ec6d5", REVIEW.escaped)],
  ["src/frontend/dashboard/dashboard-settings.ts|render|innerHTML|list", approved(1, "0b09f961a66d", REVIEW.escaped)],
  ["src/frontend/dashboard/dashboard-settings.ts|selectProvider|innerHTML|rc", approved(1, "e5e239560bc1", REVIEW.renderer)],
  ["src/frontend/dashboard/dashboard-settings.ts|showSettingsModal|innerHTML|overlay", approved(1, "0d1532c12e1d", REVIEW.static)],
  ["src/frontend/dashboard/dashboard-settings.ts|switchSettingsModal|innerHTML|l", approved(1, "cdf820177eb8", REVIEW.static)],
  ["src/frontend/dashboard/dashboard-settings.ts|switchSettingsModal|innerHTML|list", approved(1, "97a8035a3fe2", REVIEW.renderer)],
  ["src/frontend/dashboard/dashboard-settings.ts|switchSettingsModal|innerHTML|sc", approved(5, "d14ab51e38e2", REVIEW.static)],
