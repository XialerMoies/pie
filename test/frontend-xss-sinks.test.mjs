...
const APPROVED_SINKS = new Map([
  ...
  ["src/frontend/dashboard/dashboard-layout.ts|renderComponentTab|innerHTML|root", approved(1, "2da6ccc19bf9", REVIEW.escaped)],
  ["src/frontend/dashboard/dashboard-layout.ts|renderMcpManagementTab|innerHTML|root", approved(1, "3500c63e5276", REVIEW.static)],
